...
def start_metrics_deployment():
    '''Start to run splunk connect for kubernetes metrics'''
...
def kill_metrics_deployment():
    '''Kill splunk connect for kubernetes metrics'''

def start_logs_deployment():
    '''Start to run splunk connect for kubernetes logging'''

def kill_logs_deployment():
    '''Kill splunk connect for kubernetes logging'''

def start_objects_deployment():
    '''Start to run splunk connect for kubernetes objects'''

def kill_objects_deployment():
    '''Kill splunk connect for kubernetes objects'''
